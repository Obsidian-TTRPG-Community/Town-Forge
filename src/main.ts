...
export var VALID_TERRAINS = ["inland", "coastal", "river", "lake", "mountain"];
...
export var LANDSCAPE_BASE_DISTANCE = 10;
export var VALID_SETTLEMENTS = ["hamlet", "village", "small_town", "town", "large_town", "small_city", "city", "large_city", "metropolis"];
...
export var TownForgeSettingTab = class extends PluginSettingTab {
